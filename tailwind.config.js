  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        hero_shape: "url('/hero/shape-1-1.svg')",
        hero_shape2_light: "url('/hero/shape-2-light-1.svg')",
        hero_shape2_dark: "url('/hero/shape-2-dark-1.svg')",
        dots_light: "url('/dots-light.svg')",
        dots_dark: "url('/dots-dark.svg')",
        about_shape_light: "url('/about/shape-light-1.svg')",
        about_shape_dark: "url('/about/shape-dark-1.svg')",
